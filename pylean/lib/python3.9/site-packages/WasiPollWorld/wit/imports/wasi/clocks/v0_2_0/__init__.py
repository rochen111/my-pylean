...
del sys.modules["WasiPollWorld.wit.imports.wasi.clocks.v0_2_0"]
from clr import AddReference
AddReference("WasiPollWorld.wit.imports.wasi.clocks.v0_2_0")
from WasiPollWorld.wit.imports.wasi.clocks.v0_2_0 import *
