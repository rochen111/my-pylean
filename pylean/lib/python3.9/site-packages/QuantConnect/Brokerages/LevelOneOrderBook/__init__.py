...
del sys.modules["QuantConnect.Brokerages.LevelOneOrderBook"]
from clr import AddReference
AddReference("QuantConnect.Brokerages.LevelOneOrderBook")
from QuantConnect.Brokerages.LevelOneOrderBook import *
