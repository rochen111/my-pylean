...
del sys.modules["QuantConnect.Brokerages.Authentication"]
from clr import AddReference
AddReference("QuantConnect.Brokerages.Authentication")
from QuantConnect.Brokerages.Authentication import *
